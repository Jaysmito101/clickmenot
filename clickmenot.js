...
style.innerHTML = "body{background-color:rgba(0,0,0,.9)}h1{font-family:Arial;color:rgba(255,255,255,.6)}button{font-family:Arial;font-size:20px;font-weight:900;outline:0;width:160px;height:80px;border-radius:5px;border-width:1px;border-color:#111;cursor:pointer;position:absolute;overflow:hidden}i{color:#fcba03}button:hover{transform:scale(1.2)}address{color:rgba(255,255,255,.6)}";
document.head.appendChild(style);
var center = document.createElement('center');
var h1 = document.createElement('h1');
h1.id = "info";
h1.innerText = "Click Me If You Can!";
center.appendChild(h1);
var buttoni = document.createElement('button');
buttoni.id="mainButton";
buttoni.innerText="Click ME!";
center.appendChild(buttoni);
var address = document.createElement('copy');
address.innerHTML = "&copy; Jaysmito Mukherjee 2021 - 2030";
...
window.FontAwesomeKitConfig = {"asyncLoading":{"enabled":false},"autoA11y":{"enabled":true},"baseUrl":"https://ka-f.fontawesome.com","baseUrlKit":"https://kit.fontawesome.com","detectConflictsUntil":null,"iconUploads":{},"id":3820367,"license":"free","method":"css","minify":{"enabled":true},"token":"0dca02ff03","v4FontFaceShim":{"enabled":true},"v4shim":{"enabled":true},"version":"5.15.2"};
